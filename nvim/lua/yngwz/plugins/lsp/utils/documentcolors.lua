-- Source: https://github.com/ecosse3/nvim/blob/master/lua/lsp/utils/documentcolors.lua
...
function M.buf_attach(bufnr, options)
    ...
    local trigger_update_highlight, timer = require(
        "yngwz.plugins.lsp.utils.defer"
    ).debounce_trailing(M.update_highlight, options.debounce or 200, false)
